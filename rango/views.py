...
def index(request):    
    category_list = Category.objects.order_by('-likes')[:5] # - denotes descending order 
...
#this is technically not a view 
 
def visitor_cookie_handler(request): 
    visits = int(get_server_side_cookie(request,'visits','1')) 
      
    # all cookie values are returned as a string 
    ...
    # when creating a cookie using set_cookie data type does not matter, DJango automatically casts it to a string 
